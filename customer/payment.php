    ...
    <div class="card__body">
      <form method="post" action="payment.php" id="checkoutForm">
        ...
        <div class="payment-panel" data-payment-panel="ewallet" hidden>
          <h4>Pay now with GCash or Maya</h4><p class="muted">Scan the QR code with your GCash or Maya app to make the payment. This QR code points to the station’s configured wallet number. The system does not verify or process the payment in this test build.</p><div class="payment-demo-qr"><img src="<?= e($BASE) ?>/assets/images/maya-qr.svg" alt="GCash and Maya payment QR code"></div><p class="muted"><strong>On-the-spot test payment:</strong> complete the scan in your wallet app, then enter the test reference below.</p><div class="field"><label for="testPaymentReference">Test payment reference</label><input id="testPaymentReference" name="test_payment_reference" placeholder="DEMO-GCASH-001" autocomplete="off"></div>
        </div>
